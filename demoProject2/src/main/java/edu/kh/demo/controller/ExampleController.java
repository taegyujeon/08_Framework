...
@RequestMapping("example") // /example로 시작하는 주소는 해당 컨트롤러에 매핑
...
public class ExampleController {
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		stdList.add(new Student("11111","김일병",20));
		stdList.add(new Student("22222","최이병",20));
		stdList.add(new Student("33333","홍상병",20));
